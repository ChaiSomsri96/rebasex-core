...
interface IRebaseXPairErrors {
    ...
    /**
     * @notice There was an attempt to update the fees such that the protocolFee exceeded the total fee
     */
    error InvalidFees(uint16 feeBps, uint24 protocolFeeMbps);
}